                ...
                <el-header style="width: 1019.2px">
                    <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" >
                        ...
                        <el-submenu index="2">
                            ...
                            <el-menu-item index="2-2" @click="goTo('/Body/PersonalDiary')">博主日记</el-menu-item>
...
<style scoped>
    ...
    * {
    ...
    @media screen and (max-width: 176px), (max-height: 500px) {
        .player__top {
            flex-wrap: wrap;
        }
    }
    ...
    @media screen and (max-width: 110px), (max-height: 500px) {
        .player-controls {
            flex-direction: column;
            padding-left: 0;
            width: 30%;
